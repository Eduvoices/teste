...
const ReciboTecjus = ({numeroCtrl, dataAtual, cash, extenso, funcionario, cliente}) => {
    ...
    return (
        <div>
            ...
            <p style={{marginTop:'64px'}}>Recebemos de <span id="recibo_nome"><b>{nomeCompleto}</b></span> a importância de <b><span id="recibo_valor">R$ {cash}</span> ({extenso}</b>), referente ao pagamento de honorários advocatícios.</p>
