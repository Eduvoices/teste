...
const Procuração4 = (outorgante, dataAtual) => {
    return (
        <div>
            <h1>AVALON</h1>
            <h2>PROCURAÇÃO</h2>
                <p>
                Outorgante: Eu, {outorgante}, [nacionalidade], [estado civil], [profissão], portador do CPF número ____________ e do RG número ____________, residente e domiciliado em [endereço], pelo presente instrumento, nomeio e constituo, como meu procurador <br />
