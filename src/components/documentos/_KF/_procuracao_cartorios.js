...
const ProcuracaoCartoriosKF = ({cliente, estadoCivil, rg, cpf, endereco, numero, cep, bairro, cidade, uf, dia, mes, ano}) => {
    return (
        <div id="invoice-content-kf">
            ...
            <p>
            <b>{cliente}</b>, brasileiro(a), {estadoCivil}, portador do RG nº {rg}, inscrito no CPF sob o nº {cpf}, residente
                e domiciliado na rua {endereco}, nº {numero}, CEP {cep}, Bairro {bairro}, no município de {cidade} - {uf}, nomeia e
