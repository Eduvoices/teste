...
const TermoRenunciaKF = ({cliente, estadoCivil, rg, cpf, endereco, numero, bairro, cep, cidade, uf, dia, mes, ano}) => {
    return (
        <div id='invoice-content-kf'>
            ...
            <p>
                <b>{cliente}</b>, brasileiro(a), {estadoCivil}, portador(a) do RG nº {rg}, inscrito(a) no CPF sob o nº {cpf}, residente
                e domiciliado(a) na Rua {endereco}, nº {numero}, bairro {bairro}, CEP {cep}, no município de {cidade} - {uf}, <b>RENUNCIA</b> aos
