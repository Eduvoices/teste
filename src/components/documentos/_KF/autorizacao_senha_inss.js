...
const AutorizacaoSenhaInss = ({cliente, estadoCivil, profissao, rg, cpf, endereco, numero}) => {
    return (
        <div id="invoice-content-kf">
            ...
            <p><b>{cliente}</b>, brasileiro(a), <b>{estadoCivil}</b>, <b>{profissao}</b>, portador do RG: <b>{rg}</b>, inscrito no CPF: <b>{cpf}</b>, residente e domiciliado na Rua <b>{endereco}</b>, nº <b>{numero}</b>. <br/>
